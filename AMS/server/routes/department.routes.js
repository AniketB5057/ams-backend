...
import { createDepartment, updateDepartment, getallDepartment, getDepartment, deleteDepartment } from "../controllers/department.controller";
...
router.put("/:id", [authMiddleware, updateValidation, validateRequest], updateDepartment);
